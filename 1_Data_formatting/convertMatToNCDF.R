################################################################################
# Name:         convertMatToNCDF.R
# Description:	This script converts a list of .mat files (e.g. Evapotranspiration
#				data) to netCDF outputs
# version:      v1.1
...
for(i in fileList_data){
  ...
  # this is specific for ET data, as there were some processing errors concerning min/max values
  # of the dataset
