...
st <- stack(paste(path,
                  "ERA_Interim/Anomalies/SOM_exploration/som_GPA500_rlen_50_radius_1.nc",sep=""),
            bands=c(1:12),varname="GPA.som")
...
axis(side=1,at=c(-179, -90, 0, 90, 180),labels=c(-180,-90,0,90,180),line=-.8)
axis(side=2,at=c(-90,-45, 0,45,90),labels=c(-90,-45,0,45,90),line=0)
plot(st_new$SOM11,legend.only=TRUE,zlim=c(-4,-3,-2,-1,-0.5,0,0.5,1,2,3,4),col=colourPalette, horizontal=TRUE,
