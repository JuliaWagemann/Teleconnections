...
st <- stack(paste(path,
                  "4_Results/EOT/ERA_Interim/3deg/GP500_monthly_3deg_eot.nc",sep=""),
            bands=c(1:12),varname="modes_st")
...
tiff(filename=paste(path,"4_Results/EOT/ERA_Interim/3deg/GP500_monthly_3deg_EOT_modes.tiff",sep=""),
